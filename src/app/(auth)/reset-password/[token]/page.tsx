      ...
      <div className="w-full max-w-md glass-card p-8">
        {done ? (
          <div className="text-center space-y-4">
            ...
            <h2 className="text-2xl font-bold text-[#EEE6E4]">Senha redefinida!</h2>
            <p className="text-gray-400">
              Sua senha foi atualizada com sucesso. Você já pode fazer login.
            </p>
            <Link
              href="/login"
              className="inline-block w-full bg-gradient-to-r from-[#006079] to-[#009CD9] hover:from-[#007A99] hover:to-[#009CD9] text-white font-semibold py-3.5 rounded-xl text-center transition-all hover:shadow-lg hover:shadow-[#006079]/30"
            >
              Ir para o login
            </Link>
          </div>
          ...
          <>
            <div className="mb-8">
              <div className="w-12 h-12 bg-[#006079]/10 rounded-xl flex items-center justify-center mb-4">
                <Lock className="w-6 h-6 text-[#009CD9]" />
              </div>
              <h2 className="text-2xl font-bold text-[#EEE6E4] mb-2">Nova senha</h2>

    ...
    <div className="space-y-6 max-w-3xl">
      ...
      {showForm && (
        <div className="glass-card p-5 space-y-4 border-blue-500/20">
          <p className="text-sm font-semibold text-white">{editing ? "Editar FAQ" : "Nova FAQ"}</p>
            ...
            <div className="flex items-center gap-3">
              <div className="flex-1">
                ...
                <input
                  ...
                  className="w-24 bg-white/5 border border-white/10 rounded-xl px-3 py-2 text-white text-sm focus:outline-none"
                />
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex items-center gap-1 flex-shrink-0">
                  <button
                    ...
                    disabled={idx === 0}
                    className="p-1.5 text-gray-500 hover:text-white disabled:opacity-30 hover:bg-white/10 rounded-lg transition-colors"

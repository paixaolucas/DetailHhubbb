...
export function HeroSection() {
  ...
  return (
    ...
    >
      ...
      <div
        className="pointer-events-none absolute w-[500px] h-[500px] rounded-full bg-[#006079]/25 blur-[100px]"
        style={{
          left: `${mouse.x}%`,
          top: `${mouse.y}%`,
      ...
      <div
        className="pointer-events-none absolute w-64 h-64 rounded-full bg-[#009CD9]/15 blur-[80px]"
        style={{
          left: `${mouse.x + 8}%`,
          top: `${mouse.y + 5}%`,
          transform: "translate(-50%, -50%)",

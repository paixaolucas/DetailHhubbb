...
const STATUS_CONFIG: Record<string, { label: string; classes: string; dot?: boolean }> = {
  SCHEDULED: {
    label: "Agendada",
    classes: "bg-[#009CD9]/10 text-[#009CD9] border-[#009CD9]/20",
  },
  LIVE: {
    label: "Ao Vivo",
...
const RSVP_OPTIONS: { value: string; label: string; active: string; inactive: string }[] = [
  {
    ...
    inactive: "bg-white/5 border-white/10 text-gray-500 hover:text-gray-400 hover:border-[#006079]/40",
  },
  {
    value: "MAYBE",
    label: "Talvez",
  ...
  return (
    <div
      className={`bg-white/5 border rounded-2xl p-4 transition-all ${
        isLive ? "border-red-500/30" : "border-white/10 hover:border-[#006079]/40"
      }`}
    >
      {/* Status + Title */}

...
function ActorAvatar({
  ...
  return (
    <div className="w-8 h-8 bg-gradient-to-br from-blue-600 to-cyan-500 rounded-full flex items-center justify-center text-white text-xs font-bold flex-shrink-0">
      {initials || "?"}
    </div>
  );
}
...
export function NotificationDropdown({
  ...
  return (
    <div className="absolute right-0 top-full mt-2 w-80 bg-chrome-950 border border-white/10 rounded-2xl shadow-2xl overflow-hidden z-50">
      {/* Header */}

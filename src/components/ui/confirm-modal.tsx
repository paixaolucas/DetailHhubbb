...
export function ConfirmModal({
  ...
  const confirmBtnClass =
    variant === "danger"
      ...
      : "bg-[#006079] hover:bg-[#007A99] text-white";
      ...
      <div className="relative bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl p-6 w-full max-w-md shadow-2xl">
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1 min-w-0">
            <h2 id="confirm-modal-title" className="text-[#EEE6E4] font-semibold text-lg">
              {title}
            </h2>
            {description && (
        ...
        <div className="mt-6 flex justify-end gap-3">
          <button
            onClick={onCancel}
            className="px-4 py-2 rounded-xl text-sm text-gray-400 hover:text-[#EEE6E4] hover:bg-white/5 transition-colors"
          >
            {cancelLabel}
          </button>
          <button

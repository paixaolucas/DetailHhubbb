...
export function TrackInProgress() {
  ...
  if (!trail) {
    return (
      <div className="bg-[#111] border border-white/[0.06] rounded-xl overflow-hidden flex flex-col sm:flex-row items-stretch">
        <div className="w-full sm:w-40 h-36 sm:h-auto flex-shrink-0 flex items-center justify-center bg-gradient-to-br from-[#006079]/20 to-[#009CD9]/10">
          <PlayCircle className="w-12 h-12 text-[#006079]/50" />
        </div>
        <div className="flex-1 p-5 flex flex-col justify-center gap-3 min-w-0">
          <div>
            <p className="text-xs font-semibold uppercase tracking-widest text-gray-500 mb-1">Trilhas de conteúdo</p>
            <p className="text-lg font-bold text-[#EEE6E4] leading-tight">Comece sua primeira trilha</p>
            <p className="text-sm text-gray-400 mt-1">Acesse os cursos e módulos das suas comunidades.</p>
          </div>
          <Link
            href="/dashboard/meu-aprendizado"
            className="inline-flex items-center gap-2 text-sm font-semibold text-[#009CD9] bg-[#006079]/20 hover:bg-[#006079]/30 border border-[#009CD9]/20 px-4 py-2.5 rounded-xl transition-colors w-fit"
          >
  ...
  return (
    <div className="bg-[#111] border border-white/[0.06] rounded-xl overflow-hidden flex flex-col sm:flex-row items-stretch h-full">
      {/* Cover thumbnail */}
      {trail.coverImageUrl ? (
        <div className="relative w-full aspect-video sm:aspect-auto sm:w-40 sm:self-stretch flex-shrink-0">
          <Image
      ...
      <div className="flex-1 p-5 flex flex-col justify-between gap-4 min-w-0">
        <div className="space-y-2">
          ...
          <p className="text-lg font-bold text-[#EEE6E4] leading-tight line-clamp-2">{trail.title}</p>
        ...
        <div className="space-y-3">
          <div className="space-y-1.5">
            <div className="flex items-center justify-between text-sm text-gray-500 tabular-nums">
          ...
          <Link
            href={href}
            className="inline-flex items-center gap-2 text-sm font-semibold text-white bg-[#006079]/40 hover:bg-[#006079]/60 border border-[#009CD9]/20 px-4 py-2.5 rounded-xl transition-colors"
          >
            <PlayCircle className="w-4 h-4 text-[#009CD9]" />

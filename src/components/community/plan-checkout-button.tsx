...
export function PlanCheckoutButton({ planId, communitySlug, primaryColor }: PlanCheckoutButtonProps) {
  ...
  return (
    <button
      onClick={handleClick}
      disabled={isLoading}
      className="w-full py-3 rounded-xl font-semibold text-white text-sm transition-all disabled:opacity-60 disabled:cursor-not-allowed hover:opacity-90 active:scale-95 flex items-center justify-center gap-2"

...
export function MembershipSection({
  ...
  if (isMember) {
    return (
      <div className="bg-green-500/10 border border-green-500/25 rounded-2xl p-8 text-center">
        ...
        <h3 className="text-xl font-bold text-white mb-2">Você já tem acesso!</h3>
  ...
  return (
    <div className="bg-white/5 border border-white/10 rounded-2xl p-8">
      <h2 className="text-xl font-bold text-white mb-2">Planos de acesso</h2>
            ...
            >
              {plan.isDefault && (
                <div className="absolute -top-3 left-1/2 -translate-x-1/2">
                  <span className="flex items-center gap-1 text-xs bg-blue-600 text-white px-3 py-0.5 rounded-full font-semibold">

  ...
  return (
    <div className="bg-blue-500/5 border border-blue-500/20 rounded-2xl p-5 mb-6">
      ...
      <div className="flex items-start justify-between mb-4">
        <div>
          <h3 className="text-white font-semibold text-sm">Configure sua comunidade</h3>
        ...
        {items.map((item, idx) => (
          <div key={idx} className="flex items-start gap-3">
            ...
            <div className="flex-1 min-w-0">
              <p className={`text-sm font-medium leading-tight ${item.done ? "text-gray-500 line-through" : "text-gray-200"}`}>
                {item.label}
              </p>
              {!item.done && (
